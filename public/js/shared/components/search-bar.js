...
export function renderSearchBarHtml({
  ...
  _clearButtonId,
  clearHidden = true,
  wrapperClass = 'flex items-center gap-1.5 bg-gray-50/50 px-3 py-1.5 rounded-md border border-gray-100/30 w-full sm:w-80 lg:w-64 min-w-0 focus-within:ring-1 focus-within:ring-gray-200',
