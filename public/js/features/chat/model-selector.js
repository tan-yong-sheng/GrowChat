...
export function renderModelSelector(container) {
  ...
  <div class="relative" id="model-selector-wrapper">
    <button id="model-selector-btn" class="flex items-center gap-1 text-sm text-gray-500 hover:text-gray-700 transition cursor-pointer" aria-label="Select model" aria-haspopup="listbox" aria-expanded="false" aria-controls="model-selector-dropdown">
    ...
    <div id="model-selector-dropdown" class="absolute bottom-full left-0 mb-2 w-72 bg-white border border-gray-100 rounded-2xl shadow-xl z-50 hidden flex-col p-2 font-primary" role="listbox">
