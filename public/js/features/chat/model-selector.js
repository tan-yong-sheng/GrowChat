...
export function renderModelSelector(container) {
  ...
  <div class="relative" id="model-selector-wrapper">
    ...
    <div id="model-selector-dropdown" class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-[21rem] bg-surface border border-gray-100 rounded-2xl shadow-xl z-50 hidden flex-col p-2 font-primary" role="listbox">
      <div class="px-2 pt-1 pb-2 border-b border-gray-50 mb-1">
        ...
        <div class="relative flex items-center">
          ...
          <input type="text" id="model-search-input" placeholder="Search models..." class="w-full pl-9 pr-3 py-2 bg-neutral-bg border-none rounded-xl text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-300 focus-visible:ring-offset-2 focus-visible:ring-offset-surface placeholder:text-gray-500">
        </div>
      </div>
