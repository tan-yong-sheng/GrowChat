...
export function initWireChat(root, deps, ctx) {
  ...
  Object.assign(ctx, {
    syncChatUrlImpl,
    startNewChatImpl,
    refreshChatListObserverImpl,
    refreshShareStateImpl,
    loadChatsImpl,
    loadMessagesImpl,
    drawMessagesImpl,
    openCitationImpl,
    ...
    archivedModalContainer,
    citationModalContainer,
    chatListObserverArmed,
    buildChatSidebarListFragmentImpl,
    sidebarHydrationWarmupTimer,
    chatSidebarListReadyPromise,
    ensureChatSidebarListBuilder,
    armChatListObserver,
    maybeRefreshChatListObserver,
    onChatListInteraction,
    scheduleSidebarHydrationWarmup,
    sharedByChatId,
    processedRealtimeEvents,
    getMessageSeq,
    notePayloadSeq,
    ensureMessageSequenceTracker,
