          ...
          <div class="max-w-2xl mx-auto w-full space-y-3 pb-6">
            ...
            <section class="space-y-1">
              ...
              ${limitRows
                ...
                <div class="flex items-center justify-between py-2 border-b border-gray-50">
                  <span class="text-sm text-gray-700">${escapeHtml(row.label)}</span>
                  <span class="text-sm font-mono text-gray-900">${escapeHtml(String(row.value))}</span>
                </div>
              `
                )
                .join('')}
              <div class="flex items-start gap-2 py-2">
                ...
                <span class="text-[10px] text-gray-600">Rate limits are configured in deployment config and cannot be changed here.</span>
              </div>
            </section>
            ...
            <section class="space-y-1">
              ...
              <div class="flex items-start gap-2 py-2">
                ...
                <span class="text-[10px] text-gray-600">Token TTLs are configured in deployment config and cannot be changed here.</span>
              </div>
            </section>
            ...
            <section class="space-y-1">
              ...
              `
                ...
                .join('')}
              <div class="text-[10px] text-gray-600 py-2">These settings will be configurable in a future update.</div>
            </section>
