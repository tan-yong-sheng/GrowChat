...
This project is indexed by GitNexus as **GrowChat** (9326 symbols, 16547 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
