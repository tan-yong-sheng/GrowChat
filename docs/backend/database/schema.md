...
**Migration files:** `migrations/001_initial.sql`, `002_settings_permissions.sql`, `003_password_reset_tokens.sql`, `006_audit_logging.sql`, `007_google_oauth.sql`
...
| Table                       | Columns                                                                                                                                                                                                                                     | Notes                                                                                                                                                                                                                                     |
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`users`**                 | `id` PK, `email` UNIQUE, `password_hash`, `name`, `google_id` (nullable, partial unique index), `account_status`, `settings` (JSON), `preferences` (JSON), `avatar`, `avatar_emoji`, `status`, `last_active_at`, `created_at`, `updated_at` | `account_status`: `'active'` \| `'pending'`. `status`: `'online'` \| `'away'` \| `'offline'`. `google_id`: Google OAuth `sub` ID (nullable, unique where not null). `password_hash`: `'oauth:no-password'` sentinel for Google-only users |
