...
module.exports = [
  ...
  // TODO: Refactor these into sub-handlers and remove this override.
  {
    files: [
      ...
      'src/routers/models/models-discovery-helpers.js',
      ...
      'public/js/features/admin/settings/connections-modal-form-render-models.js',
      ...
      'src/chat/assistant-runner-stream-event.js',
